...
def helper(dis):
    ...
    desc = ' '.join(desc.astype(str).tolist())
    ...
    wrk = workout[workout['disease'] == dis]['workout'].astype(str).tolist()
...
def predict():
    ...
    try:
        ...
        dis_des, pre, meds, rec_diet, wrk = helper(predicted_disease)
